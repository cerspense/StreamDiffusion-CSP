...
class PreprocessMorphologyPreprocessor(BasePreprocessor):
    """
    Morphological operations (dilate/erode) preprocessing.

    Operates BEFORE VAE encode to apply dilate and erode effects.
    Great for expanding/contracting bright areas, creating halos, or softening edges.
    """

    @classmethod
    def get_preprocessor_metadata(cls):
        return {
            "display_name": "Morphology (Pre-VAE)",
            "description": "Morphological dilate/erode operations. Applied before VAE encode.",
            "parameters": {
                "dilate_amount": {
                    "type": "float",
                    "default": 0.0,
            ...
            "use_cases": [
                "Expand bright regions (dilate)",
                "Contract bright regions (erode)",
                "Create halos or glows",
    ...
    def __init__(self,
                 ...
                 **kwargs):
        """
        Initialize PreprocessMorphology preprocessor
